  ...
  try {
    const response = await fetch("https://api.openai.com/v1/responses", {
      ...
      body: JSON.stringify({
        model: "gpt-4.1-mini",
        store: false,
        instructions: "당신은 대한민국 유아교육 전문가입니다. 입력된 유아의 실제 관심과 놀이 환경을 바탕으로 교사가 바로 활용할 수 있는 놀이 실행안을 한국어로 작성하세요. 2019 개정 누리과정의 놀이 중심 철학을 따르되 성취를 단정하지 마세요. 유아 선택권, 안전, 관찰을 존중하고 과도한 지시식 활동을 피하세요. 각 항목은 구체적이며 서로 중복되지 않게 쓰세요. process에는 도입/전개/마무리의 흐름, support에는 환경·자료·교사 개입 시점, participation에는 유아/교사 각각의 역할, reflection에는 관찰 포인트와 다음 놀이 제안을 포함하세요. dialogue에는 자연스러운 교사-유아 발화 3쌍을 쓰세요. 일반적인 문구보다 입력 맥락에 맞는 사례를 우선하세요.",
